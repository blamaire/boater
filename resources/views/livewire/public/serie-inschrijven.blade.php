<div class="space-y-3">
    ...
    @auth
        ...
        @if ($activeCount > 0)
            <div class="text-sm">
                Je bent ingeschreven voor <span class="font-medium">{{ $activeCount }}</span> voorkomen(s) van deze reeks.
            </div>
        ...
        @else
            ...
            <p class="text-xs text-gray-500">Capaciteit en wachtlijst gelden per voorkomen — voor een vol voorkomen kom je op de wachtlijst.</p>
        @endif
    @else
